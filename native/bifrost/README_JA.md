...
GPUはInteractive Distribution conflictと対象となるOrientationに使用します。Bifrost Mesh encode、construct_mesh、DistributionはInteractiveでOpenCL、Settledで決定的CPU三角形Field補間、Finalで候補ごとのCPU exactです。0.10.5以前のDLLは再利用せず、0.10.6 SourceからClean Buildしてください。
