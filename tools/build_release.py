...
def build() -> dict[str, str]:
    ...
    build_info = {
        ...
        "gpu_buffer_schema": "interactive-conflict-gpu/1-plus-compact-orientation-buffer/1",
        ...
        "cell_cache_key_basis": "distribution-or-orientation-anisotropic",
        ...
        "direction_anisotropy_max_axis_ratio": 1.45,
